        ...
        <div class="panel-body">
            <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row"> 
                             @foreach($objetivo->Indicadores As $indicador)
                                ...
                                @if(count($objetivo->indicadores)>1) 
                                <a href="{{route('indicador.destroy',[$indicador->id, $indicador->id_objetivo])}}" onclick=" return confirm('Desea eliminar este indicador?')" class="btn btn-danger" size="20"  >
                        ...
                        <div class="form-group">
                            <div class="row"> 
                             ...
                             @foreach($objetivo->Metas As $meta)
                                ...
                                @if(count($objetivo->metas)>1) 
                                <div class="col-sm-2" ><br/>

                                <a href="#" onclick=" return confirm('Desea eliminar esta meta?')" class="btn btn-danger" size="20"  >
                                    <span class="glyphicon glyphicon-minus" aria-hidden="true"></span>
                                    Remover
                                </a></div>
                                @endif
                        ...
                        <div class="form-group">
                            <div class="row"> 
                             ...
                             @foreach($objetivo->Iniciativas As $iniciativa)
                                ...
                                @if(count($objetivo->Iniciativas)>1) 
                                <div class="col-sm-2" ><br/>

                                <a href="#" onclick=" return confirm('Desea eliminar esta iniciativa?')" class="btn btn-danger" size="20"  >
                                    <span class="glyphicon glyphicon-minus" aria-hidden="true"></span>
                                    Remover
                                </a></div>
                                @endif
                ...
                <div class="form-group">
                    ...
                    <a href="{{route('objetivo.index')}}" class="btn btn-default ">
                          Volver
                    </a>
                </div>
                {!! Form::close() !!}
