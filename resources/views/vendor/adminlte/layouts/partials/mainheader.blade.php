...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-mini"><b>Up</b>NE</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Drocha-</b>T-Virus</span>
    </a>
                ...
                @else
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{ Auth::user()->img ? Auth::user()->img :asset('img/avatar5.png') }}" class="user-image" alt="User Image"/>
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <!-- <li class="user-body">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ route('user.perfil') }}" class="btn btn-default btn-flat">{{ trans('adminlte_lang::message.profile') }}</a>
                                </div>
